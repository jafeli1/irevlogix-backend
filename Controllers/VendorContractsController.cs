...
namespace irevlogix_backend.Controllers
{
    ...
    public class VendorContractsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetById([FromRoute] int id)
        {
            ...
            var item = await _context.VendorContracts
                .Include(x => x.Vendor)
        ...
        public async Task<IActionResult> Patch([FromRoute] int id, [FromBody] UpdateVendorContractDto dto)
        {
            ...
            var entity = await _context.VendorContracts.FirstOrDefaultAsync(x => x.Id == id && x.ClientId == clientId);
        ...
        public async Task<IActionResult> UploadFile(IFormFile file)
        {
            ...
            var uploadsPath = Path.Combine(Directory.GetCurrentDirectory(), "uploads", "vendor-contracts");
            ...
            var relativePath = Path.Combine("uploads", "vendor-contracts", fileName).Replace("\\", "/");
