...
namespace irevlogix_backend.Controllers
{
    ...
    public class ProcessedMaterialTestsController : ControllerBase
    {
        ...
        public async Task<IActionResult> UploadFile(IFormFile file)
        {
            ...
            var uploadsPath = Path.Combine(Directory.GetCurrentDirectory(), "uploads", "processed-material-tests");
            ...
            var relativePath = Path.Combine("uploads", "processed-material-tests", fileName).Replace("\\", "/");
